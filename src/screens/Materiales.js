...
export default function MaterialesScreen() {
  const materiales = [
    ...
    {name: "Chasis", image: "https://natytec.com.mx/wp-content/uploads/2017/09/Icono1.jpg", descripcion:"Estructura base del carrito. Soporta todos los componentes.", categoria: "Estructura y montaje" },
